export async function onRequest(context) {
  ...
  let sessionId = cookies['_ceci_sid'] || '';
  let externalId = cookies['_ceci_eid'] || '';
  ...
  newHeaders.append('Set-Cookie', `_ceci_sid=${sessionId}; ${cookieBase}`);
  newHeaders.append('Set-Cookie', `_ceci_eid=${externalId}; ${cookieBase}`);
